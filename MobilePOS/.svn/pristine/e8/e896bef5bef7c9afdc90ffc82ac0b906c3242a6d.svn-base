<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="WeekLyReport.aspx.cs" Inherits="MobilePOS.WeekLyReport" %>
    ...
    <div style="margin: 0 auto;width:950px; border-radius:6px; ">
        <div id="panelBox" class="panel panel-info" runat="server">
            <div class="panel-heading">
                <asp:Label ID="lblTitle" runat="server" Text="Weekly Report" Font-Bold="True"></asp:Label>
            </div>
                ...
                <asp:MultiView ID="mvMain" runat="server" ActiveViewIndex="0">
                    <asp:View ID="vwMain" runat="server">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvWeeklyRep" runat="server"
                                        GridLines="None"  
                                        ...
                                        onpageindexchanging="gvWeeklyRep_PageIndexChanging"  >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="WeekIn" HeaderStyle-Width="100" HeaderText="Week Index" ItemStyle-HorizontalAlign="Right"/>
